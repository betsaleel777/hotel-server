...
class CreateFacturesCocktailsExternesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('factures_cocktails_externes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('factures_cocktails_externes');
    }
}
