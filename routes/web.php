...
$router->group(['prefix' => 'public'], function () use ($router) {
    $router->get('categories', 'GestionChambre\CategoriesController@getCategories');
    $router->post('reservations/new', 'Reception\ReservationsController@create');
    $router->get('client/{code}', 'Reception\ClientsController@getOneByCode');
    $router->get('hebergements/{categorie}', 'Reception\ReservationsController@utiliseesByCategorie');
    $router->get('chambres/categorie/{categorie}', 'GestionChambre\ChambresController@getByCategorie');
});
...
$router->group(['middleware' => 'auth'], function ($router) {
    ...
    $router->group(['prefix' => 'gestion-chambre'], function () use ($router) {
        $router->group(['prefix' => 'chambres'], function () use ($router) {
            ...
            $router->get('/categorie/{categorie}', 'GestionChambre\ChambresController@getByCategorie');
